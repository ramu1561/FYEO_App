...
/// Defaults to not `nil`. Can be overriden directly or set to `nil` to hide a button from the toolbar.
@property(readonly, nonatomic, nullable) UIButton *closeButton RFS_DEPRECATED(7.2, "Use other ways to customize buttons (`customUILayerJSON` in `UIConfiguration` class)");
