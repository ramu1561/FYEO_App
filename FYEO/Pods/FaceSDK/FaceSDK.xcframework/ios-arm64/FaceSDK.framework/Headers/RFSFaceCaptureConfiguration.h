...
#import <FaceSDK/RFSScreenOrientation.h>
...
/// Enables global face hint animation. Defaults to `true`.
@property(readonly, nonatomic, assign) BOOL showFaceAnimation;
/// Allows you to specify an orientation of the camera view controller. Defaults to `RFSScreenOrientationPortrait`.
@property(readonly, nonatomic, assign) RFSScreenOrientation screenOrientation;
...
/// @see RFSFaceCaptureConfiguration.showFaceAnimation.
@property(readwrite, nonatomic, assign) BOOL showFaceAnimation;
/// @see RFSFaceCaptureConfiguration.orientation.
@property(readwrite, nonatomic, assign) RFSScreenOrientation screenOrientation;
