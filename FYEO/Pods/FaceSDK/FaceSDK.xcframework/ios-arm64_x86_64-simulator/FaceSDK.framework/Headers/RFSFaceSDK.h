...
/// Defines customer name. Defaults to `nil`.
@property(readwrite, nonatomic, copy, nullable) NSString *tenant;

/// Defines environment type. Defaults to `nil`.
@property(readwrite, nonatomic, copy, nullable) NSString *env;
